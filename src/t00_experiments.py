...
ML_MODEL_NAME = "resnet_50-model.pth.tar-50"
...
gal_pbs = dataset.get_pbs_by_dates(dates[:2])
...
for i in range(3, len(dates) + 1):
    ...
    test = ReidExperiment(exp_name="t00",
...
test_damaged = ReidExperiment(exp_name="t00",
                        model_name=full_model_name,
